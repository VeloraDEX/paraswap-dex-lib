...
| oswap                                                          | one per pool config                                | plain: `{ t0: balance0, t1: balance1 }`                                                                                                                                                                                                                                                              | event state                                                                             |
...
| miro-migrator                                                  | single pool                                        | directional: `{ old_vlr: balance }`                                                                                                                                                                                                                                                                  | event state                                                                             |
| erc4626                                                        | one per vault key                                  | directional: `{ asset_vault: UNLIMITED if deposit enabled, vault_asset: totalAssets if redeem enabled }`; a disabled direction has no key                                                                                                                                                            | event state + config flags                                                              |
| angle-transmuter                                               | one per stablecoin                                 | directional: `{ collateral_i_stable: UNLIMITED, stable_collateral_i: collateral_i.balanceOf(transmuter) }` per collateral                                                                                                                                                                            | multicall over the collateral list (the USD sum lives on the pool-tracker service only) |
...
| aave-v3-pt-roll-over                                           | one per PT market in `marketsCache`                | directional, `UNLIMITED` on each supported `in_out`                                                                                                                                                                                                                                                  | market cache                                                                            |
...
| cap                                                            | one per (vault, asset)                             | plain, `UNLIMITED` both                                                                                                                                                                                                                                                                              | `AllVaultConfigs`                                                                       |
...
| fx-protocol-rusd, deth (dETH, dBNB, dPOL), angle-staked-stable | single pool per key                                | directional, `UNLIMITED` on each supported `in_out`                                                                                                                                                                                                                                                  | config                                                                                  |
| polygon-migrator                                               | single pool                                        | plain: `{ matic: UNLIMITED, pol: UNLIMITED }`                                                                                                                                                                                                                                                        | config                                                                                  |
| swell                                                          | one per (swETH, rswETH)                            | directional: `{ eth_share: UNLIMITED }`                                                                                                                                                                                                                                                              | config                                                                                  |
